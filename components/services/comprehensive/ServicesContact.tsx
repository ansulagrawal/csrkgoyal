    ...
    <section className="py-20 bg-gradient-to-br from-slate-800 to-slate-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center hover:bg-white/20 transition-colors duration-200">
            <MessageCircle className="w-8 h-8 text-emerald-200 mb-4 mx-auto" />
            <h3 className="font-semibold text-lg mb-2">Live Chat</h3>
            <p className="text-slate-300 mb-4 text-sm">Quick questions</p>
            <button className="text-white font-semibold hover:text-emerald-200 transition-colors duration-200">
              Start Chat
            </button>
          </div>
        </div>
