  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        emerald: {
          50: "oklch(0.976 0.013 166.107)",
          100: "oklch(0.943 0.044 166.779)",
          200: "oklch(0.885 0.079 160.641)",
          300: "oklch(0.813 0.124 162.329)",
          400: "oklch(0.724 0.171 161.275)",
          500: "oklch(0.647 0.208 160.267)",
          600: "oklch(0.558 0.206 161.067)",
          700: "oklch(0.472 0.181 162.142)",
          800: "oklch(0.389 0.148 164.260)",
          900: "oklch(0.324 0.123 164.989)",
          950: "oklch(0.179 0.071 166.107)",
        },
        amber: {
